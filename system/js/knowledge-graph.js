...
function createCaseKnowledgeGraph() {
  ...
  setTimeout(() => {
    graphElements.transition().duration(1000).attr("opacity", 1);
  }, 500);
...
function createNodeGradients(svg) {
  ...
  gradient1.append("stop").attr("offset", "0%").attr("stop-color", "#3498db");

  gradient1.append("stop").attr("offset", "100%").attr("stop-color", "#2980b9");
  ...
  gradient2.append("stop").attr("offset", "0%").attr("stop-color", "#e74c3c");

  gradient2.append("stop").attr("offset", "100%").attr("stop-color", "#c0392b");
  ...
  gradient3.append("stop").attr("offset", "0%").attr("stop-color", "#2ecc71");

  gradient3.append("stop").attr("offset", "100%").attr("stop-color", "#27ae60");

  // Group 4: Relations (purple)
  const gradient4 = defs
    .append("radialGradient")
    .attr("id", "gradient-4")
    .attr("cx", "30%")
    .attr("cy", "30%")
  ...
  gradient4.append("stop").attr("offset", "0%").attr("stop-color", "#9b59b6");

  gradient4.append("stop").attr("offset", "100%").attr("stop-color", "#8e44ad");
}
